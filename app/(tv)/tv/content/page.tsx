// TV dashboard CONTENT (loaded inside iframe at /tv).
// No meta-refresh, no auto-reload JS — the parent iframe handles that.
// This page just renders the dashboard once with current data.
...
// ISR cache for 60s — matches parent's iframe-reload interval.
...
export default async function TvContentPage() {
    ...
    >
            ...
            <tr>
              ...
              >
                ...
                <div style={{ marginTop: 22 }}>
                  {trains.filter((t) => t.scheduledMs - nowMs > -60000).length === 0 && (
        ...
        >
          <tbody>
            ...
            <tr>
              {[
                { title: "LIFT REPAIR WORKS", content: "Residents are advised that the lift is out of service for safety reasons while the Owners Corporation awaits a report from Kone (Fuji). Please use the stairwell." },
                { title: "NEXT HARD RUBBISH COLLECTION", content: "No dates booked" },
                { title: "HORIZON CONTACT", content: "Horizon Strata Management Group 03 9687 7788 info@horizonstrata.com.au" },
              ].map((news, i) => (
                <td
                  key={i}
                  style={{
